...
def kls_step(x, z, enc_init, enc_local, q_eta, q_z, N, K, D, num_samples, batch_size):
    #### samples
    ...
    post_mean, post_nu, post_alpha, post_beta = post_global(x, z, p_mean, p_nu, p_alpha, p_beta, N, K, D)
