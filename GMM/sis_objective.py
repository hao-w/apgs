...
"""
Sequential Improtance Sampling objective in GMM problem
==========
sampling scheme:
...
==========
"""
def sis_objective(model, apg_sweeps, ob, loss_required=True, ess_required=True, mode_required=False, density_required=False, kl_required=True):
