...
def Eubo_oneshot_eta_cfz(oneshot_eta, enc_eta, gibbs_z, obs, N, K, D, mcmc_size, sample_size, batch_size, device, idw_flag=True):
    """
    initialize eta
    ...
    ## EUBO, ELBO, ESS
    eubos[0] = ((weights**2 - weights) * log_weights).sum(0).mean()
