...
def Eubo_cfz_init_z(enc_eta, gibbs_z, obs, N, K, D, mcmc_size, sample_size, batch_size, device, RESAMPLE=False, DETACH=True):
    """
...
def Eubo_cfz_init_eta(enc_eta, gibbs_z, obs, N, K, D, mcmc_size, sample_size, batch_size, device, RESAMPLE=False, DETACH=True):
    """
    Use Gibbs update for z, in order to use reparameterized-style gradient estimation
    initialize eta
    """
