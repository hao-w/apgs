...
def APG(models, K, D, frames, mcmc_steps, mnist_mean, crop):
    """
    ...
    phi_loss, theta_loss, ess, w_what, z_where, z_what = Init_step(os_coor, dec_coor, enc_digit, dec_digit, K, D, frames, crop, mnist_mean)
    ...
    for m in range(mcmc_steps):
        ...
        phi_loss_where, theta_loss_where, ess_where, w_where, z_where = Update_where(enc_coor, dec_coor, dec_digit, frames, crop, z_what, z_where_old=z_where)
