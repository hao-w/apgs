...
def EP(models, obs, SubTrain_Params, p_flag):
    """
    ...
    (oneshot_eta, enc_z, dec_x) = models
    ...
    log_obs_n = Learn_log_likelihood(dec_x, obs, state, obs_mu, obs_rad, noise_sigma, K, cluster_flag=False)
