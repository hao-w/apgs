...
class Viz_MC:
    ...
    """
    def __init__(self, K, viz_interval, fs, title_fontsize, ob_ms, mu_marker,mu_ms, opacity, bound, colors, b, u, l, r):
        super().__init__()
        self.K = K
    ...
    def Plot_metrics(self, ll, ess, sample_size, filename):
        num_cols = len(ll)
